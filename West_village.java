...
public class West_village implements Runnable{
	...
	public West_village(Semaphore sem){
		this.sem= sem;
	}//end of west village
	public void work(int num){
		...
		try{
			...
			System.out.println("West_village_"+num+" is traveling on the road.");//haveing the village pass through
			Thread.sleep(rand.nextInt(1000));
			System.out.println("West_village_"+num+" "+tasks[taskNum]);//doing task
			Thread.sleep(rand.nextInt(1000));
		}
			...
			System.out.println("West_village_"+num+" Finished the exchange");//village done on the road
